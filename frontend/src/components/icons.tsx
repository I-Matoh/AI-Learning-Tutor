 ...
 * 
 * Uses inline SVG for consistency and to avoid external icon library dependencies.
 * All icons use the "outline" style with 2px stroke width.
 */
...
/**
 * Icon library containing all application icons.
 * Each icon is a functional React component that renders an SVG.
 * 
 * Usage: <Icons.BookOpen className="w-6 h-6" />
 */
export const Icons: Record<IconName, IconComponent> = {
  /** Open book icon - represents learning/reading content */
  ...
  /** Checkmark in circle - indicates completed/successful state */
  CheckCircle: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
  ),

  /** Empty circle - represents an available/pending item */
  ...
  /** Lock icon - indicates locked/unavailable content */
  ...
  /** Play triangle - initiates quiz or video content */
  ...
  /** Sparkles/stars - represents AI generation or premium features */
  ...
  /** Right arrow - proceed/continue action */
  ...
  /** X/close icon - dismiss or close action */
  X: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
  ),

  /** Refresh/loading icon - indicates loading or refresh action */
  ...
  /** Award/medal icon - represents achievement or completion */
